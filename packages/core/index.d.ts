// Originally from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/@minocoko/rjsf-core/index.d.ts

declare module '@minocoko/rjsf-core' {
...
declare module '@minocoko/rjsf-core/lib/components/fields/SchemaField' {
    import { JSONSchema7 } from 'json-schema';
    import { FieldProps, UiSchema, IdSchema, FormValidation } from '@minocoko/rjsf-core';
...
declare module '@minocoko/rjsf-core/lib/validate' {
    import { JSONSchema7Definition } from 'json-schema';
    import { AjvError, ErrorSchema, FormProps } from '@minocoko/rjsf-core';
